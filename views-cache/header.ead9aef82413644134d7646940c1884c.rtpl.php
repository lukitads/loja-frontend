...
<html lang="pt-br">
  <head>
    ...
    <title>Loja Virtual - Lucas Deschamps</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="/home/cart/checkout/profile"><i class="fa fa-user"></i> Minha Conta</a></li>
                            <li><a href="#"><i class="fa fa-heart"></i> Lista de Desejos</a></li>
                            <li><a href="/home/cart"><i class="fa fa-shopping-cart"></i> Meu Carrinho</a></li>
                            <?php if( checkLogin(false) ){ ?>

                            <li><a href="/home/cart/profile"><i class="fa fa-user"></i> <?php echo getUserName(); ?></a></li>
                            <li><a href="/home/cart/logout"><i class="fa fa-close"></i> Sair</a></li>
                            <?php }else{ ?>

                            <li><a href="/home/cart/login"><i class="fa fa-lock"></i> Login</a></li>
                            <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/home/cart">Carrinho - <span class="cart-amunt">R$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/home/cart">Carrinho</a></li>
                    </ul>
                </div>  
            </div>
        </div>
