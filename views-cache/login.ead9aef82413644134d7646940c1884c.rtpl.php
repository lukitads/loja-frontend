    ...
    <div class="container">
        <div class="row">                
            <div class="col-md-6">
                ...
                <form action="/home/cart/login" id="login-form-wrap" class="login" method="post">
                    <h2>Acessar</h2>
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/home/cart/login/register" class="register" method="post">
                    <h2>Criar conta</h2>
                    <p class="form-row form-row-first">
